...
export default class RequestPopup extends Component {
  ...
  getStyles = () => {
    return {
      ...
      requestContainer: this.state.expanded ? {
        flexDirection: 'column',  
        alignItems: 'center',     
      } : {
        flexDirection: 'row',     
      },
      requestInfo: this.state.expanded ? {
        flex: 0,
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.content}>
            <View
              style={[styles.requestContainer, this.getStyles().requestContainer]}
              {...this._panResponder.panHandlers}
            >
              
              {/* Title and genre */}
              <View style={[styles.reqeustInfo, this.getStyles().requestInfo]}>
          ...
          <View style={styles.footer}>
            ...
            >
              <Text style={styles.button}>Get in contact</Text>
            </TouchableHighlight>
          </View>
