        ...
        return (
                ...
                source={{
                    html:
                        ...
                        <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the UExchange App (the "Service") operated by  Matt Passarelli ("us", "we", or "our").</p>

                        <p>Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service.</p>

                        <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service. The Terms of Service agreement  has been created with the help of <a href="https://termsfeed.com/">TermsFeed</a>.</p>
